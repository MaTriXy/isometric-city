...
export const BOATS_PER_DOCK = 7.5; // Number of boats per marina/pier (5x density)
export const BOATS_PER_DOCK_MOBILE = 2.5; // Mobile: fewer boats per dock (5x density)
export const MAX_BOATS = 60; // Maximum total boats in the city (5x density)
export const MAX_BOATS_MOBILE = 20; // Mobile: fewer boats for performance (5x density)
...
export const TRAIN_SMOKE_BASE_OPACITY = 0.6; // Higher opacity for compact puffs
